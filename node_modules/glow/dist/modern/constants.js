...
const STDOUT_WIDTH = exports.STDOUT_WIDTH = process.stdout && typeof process.stdout.columns === 'number' ? process.stdout.columns : 80;

const STDOUT_HEIGHT = exports.STDOUT_HEIGHT = process.stdout && typeof process.stdout.rows === 'number' ? process.stdout.rows : 100;
