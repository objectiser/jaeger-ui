...
class Interface extends _events2.default {
  ...
  _setCurrentIndex(index) {
    ...
    let sections = this._results.map((result, index) => {
    ...
    let lastSectionHeight = sections[sections.length - 1].split('\n').length - 1;

    let topPad = 4;
    let bottomPad = Math.max(_constants.STDOUT_HEIGHT - lastSectionHeight - topPad, topPad);
