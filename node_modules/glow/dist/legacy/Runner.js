...
var Runner = exports.Runner = function (_EventEmitter) {
          ...
          switch (_context.prev = _context.next) {
            case 0:
              if (this.env.watch) {
                ...
                watcher.on('change', (0, _lodash2.default)(function () {
                  _this2.changed = true;
                  _this2.emit('change');
                }, 200));
              }
  ...
  Runner.prototype.render = function render() {
      ...
      filteredResults = results.filter(function (result) {
        ...
        return result.error.message.find(function (messagePart) {
          if (messagePart.loc && messagePart.loc.source) {
            return (0, _multimatch2.default)(messagePart.loc.source, filters).length;
          } else {
            return false;
          }
        });
    ...
    var message = this.env.lang.get(results.length === 1 ? 'foundError' : 'foundErrors', results.length);

    if (filteredResults.length !== results.length) {
      message = this.env.lang.get('foundErrorsWithFilters', message, filteredResults.length);
    }
    ...
    if (this.env.interface) {
      ...
      for (var _iterator2 = filteredResults, _isArray2 = Array.isArray(_iterator2), _i2 = 0, _iterator2 = _isArray2 ? _iterator2 : (0, _getIterator3.default)(_iterator2);;) {
        var _ref6;
